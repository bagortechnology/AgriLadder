function searchJobs() {
  ...
  // Filter job postings based on search input values or reset to original postings
  let filteredPostings;
  if (jobSearchValue !== '' || locationSearchValue !== '') {
    filteredPostings = originalPostings.filter(posting => {
    ...
    filteredPostings = originalPostings;
  }
